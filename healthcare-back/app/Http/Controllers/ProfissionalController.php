...
class ProfissionalController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            $result['data'] = $this->profissionalService->getAll();
        } catch (Exception $e) {
            $result = [
                'status' => 500,
                'error' => $e->getMessage()
    ...
    public function store(Request $request)
    {
        ...
        try {
            $result['data'] = $this->profissionalService->saveProfissionalData($data);
        } catch (Exception $e) {
            $result = [
                'status' => 500,
                'error' => $e->getMessage()
    ...
    public function show($id)
    {
        ...
        try {
            $result['data'] = $this->profissionalService->getById($id);
        } catch (Exception $e) {
            $result = [
                'status' => 500,
                'error' => $e->getMessage()
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $result['data'] = $this->profissionalService->updateProfissional($data, $id);
        } catch (Exception $e) {
            $result = [
                'status' => 500,
                'error' => $e->getMessage()
